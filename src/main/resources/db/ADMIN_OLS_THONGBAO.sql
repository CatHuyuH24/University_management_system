...
-- connect bằng ATBMCQ_ADMIN
-- Gán quyền kết nối user test

-- Grant quyền test cho user NV001 - Nhân viên thường
GRANT EXECUTE ON ADMIN_OLS.GET_ALL_THONGBAO TO NV001;
GRANT EXECUTE ON ADMIN_OLS.GET_ALL_LABELS TO NV001;

-- Grant quyền test cho user NV006 - Trưởng đơn vị
GRANT EXECUTE ON ADMIN_OLS.GET_ALL_THONGBAO TO NV006, NV001;
GRANT EXECUTE ON ADMIN_OLS.GET_ALL_LABELS TO NV006, NV001;
GRANT SELECT ON SYS.DBA_USERS TO NV006, NV001; --CHẠY BẰNG SYS
GRANT EXECUTE ON ADMIN_OLS.INSERT_THONGBAO TO NV006, NV001;
GRANT EXECUTE ON ADMIN_OLS.GET_USER_LIST TO NV006, NV001;
GRANT EXECUTE ON ADMIN_OLS.SET_OLS_LABEL_FOR_USER TO NV006, NV001;
GRANT EXECUTE ON ADMIN_OLS.GET_ALL_USER_LABELS TO NV006, NV001;
