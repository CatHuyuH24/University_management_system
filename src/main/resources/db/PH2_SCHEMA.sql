...
GRANT CONNECT TO NV003, NV007, SV001, SV002, SV003, SV004, SV005;
GRANT EXECUTE ON ATBMCQ_ADMIN.IS_ADMIN_USER TO NV003, NV007, SV001, SV002, SV003, SV004, SV005;
...
GRANT CONNECT TO NV_PKT;
GRANT SELECT ON SINHVIEN TO NV_PKT;
GRANT UPDATE(DIEMQT, DIEMTH, DIEMTK, DIEMCK) ON DANGKY TO NV_PKT;
-- Cấp quyền cho user (ví dụ quyền connect)
GRANT NV_PKT TO NV009;
