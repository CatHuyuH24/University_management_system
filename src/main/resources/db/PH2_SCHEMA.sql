...
GRANT CONNECT TO NV001, NV002, NV004, NV006;
...
GRANT SELECT, UPDATE(MASV, MAMM), INSERT, DELETE ON DANGKY TO ROLE_SINHVIEN;

-- QUYỀN CHO ROLE_NVCTSV
GRANT INSERT, DELETE, UPDATE ON SINHVIEN TO ROLE_NVCTSV;
...
-- Cấp quyền kết nối
GRANT CREATE SESSION TO NV003, NV010, SV001, SV002, SV003, SV004, SV005;
GRANT CONNECT TO NV003, NV010, SV001, SV002, SV003, SV004, SV005;
GRANT EXECUTE ON ATBMCQ_ADMIN.IS_ADMIN_USER TO NV003, NV010, SV001, SV002, SV003, SV004, SV005;
...
GRANT CONNECT TO ROLE_NVPKT;
GRANT SELECT ON SINHVIEN TO ROLE_NVPKT;
GRANT UPDATE(DIEMQT, DIEMTH, DIEMTK, DIEMCK) ON DANGKY TO ROLE_NVPKT;

-- Tạo user USER_PKT
CREATE USER NV009 IDENTIFIED BY 9;
-- Cấp quyền cho user (ví dụ quyền connect)
