...
INSERT INTO DONVI (MADV, TENDV, LOAIDV, TRGDV)
VALUES ('PKT', 'Phòng Khảo thí', 'Phòng', NULL);
...
INSERT INTO NHANVIEN (MANV, HOTEN, PHAI, NGSINH, LUONG, PHUCAP, DT, VAITRO, MADV)
VALUES ('NV007', 'Thu Thi K', 'Nu', TO_DATE('1992-12-12', 'YYYY-MM-DD'), 900, 150, '0966819011', 'NV CTSV', 'CTSV');
INSERT INTO NHANVIEN (MANV, HOTEN, PHAI, NGSINH, LUONG, PHUCAP, DT, VAITRO, MADV)
VALUES ('NV008', 'Truong Hoang V', 'Nam', TO_DATE('2002-02-07', 'YYYY-MM-DD'), 1000, 110, '0936313031', 'NV TCHC', 'TCHC');
INSERT INTO NHANVIEN (MANV, HOTEN, PHAI, NGSINH, LUONG, PHUCAP, DT, VAITRO, MADV)
VALUES ('NV009', 'Lam Cao T', 'Nu', TO_DATE('2000-07-07', 'YYYY-MM-DD'), 1000, 110, '0936212121', 'NV PKT', 'PKT');
INSERT INTO NHANVIEN (MANV, HOTEN, PHAI, NGSINH, LUONG, PHUCAP, DT, VAITRO, MADV)
VALUES ('NV010', 'Lam Cao K', 'Nu', TO_DATE('2000-06-07', 'YYYY-MM-DD'), 1200, 110, '0936212321', 'NV PĐT', 'PĐT');
...
INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM)
VALUES ('MM006', 'HP001', 'NV003', 1, 2025);
INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM)
VALUES ('MM007', 'HP003', 'NV003', 1, 2024);
INSERT INTO MOMON (MAMM, MAHP, MAGV, HK, NAM)
VALUES ('MM008', 'HP003', 'NV003', 3, 2025);
...
GRANT CONNECT TO NV001, NV002, NV004, NV006, NV007;
GRANT EXECUTE ON ATBMCQ_ADMIN.IS_ADMIN_USER TO NV001, NV002, NV004, NV006;
----------------------------------------------------------------------------------------------------------------------------
-- Cau 2:
-- Tạo role
CREATE ROLE ROLE_GV;
...
GRANT ROLE_NVCB TO ROLE_NVPDT;
GRANT ROLE_NVCB TO ROLE_NVCTSV;
...
WHERE (HK, NAM) = (
    SELECT 
        CASE 
            ...
            WHEN EXTRACT(MONTH FROM SYSDATE) >= 5 THEN 3
            ELSE 2
        END AS HK,
        EXTRACT(YEAR FROM SYSDATE) AS NAM
    FROM DUAL
)
WITH CHECK OPTION;
...
GRANT SELECT, INSERT, UPDATE(MASV, MAMM), DELETE ON DANGKY TO ROLE_NVPDT;
...
GRANT SELECT, UPDATE(MAMM), INSERT, DELETE ON DANGKY TO ROLE_SINHVIEN;

-- QUYỀN CHO ROLE_NVCTSV
GRANT SELECT, INSERT, DELETE, UPDATE ON SINHVIEN TO ROLE_NVCTSV;

-- Tạo người dùng
CREATE USER NV003 IDENTIFIED BY 3;
CREATE USER NV010 IDENTIFIED BY 10;
...
GRANT ROLE_NVPDT TO NV010;
GRANT ROLE_NVCTSV TO NV007;
GRANT ROLE_SINHVIEN TO SV001, SV002, SV003, SV004, SV005;


-- Cấp quyền kết nối
GRANT CREATE SESSION TO NV003, NV010, SV001, SV002, SV003, SV004, SV005, NV007;
GRANT CONNECT TO NV003, NV010, SV001, SV002, SV003, SV004, SV005, NV007;
GRANT EXECUTE ON ATBMCQ_ADMIN.IS_ADMIN_USER TO NV003, NV010, SV001, SV002, SV003, SV004, SV005, NV007;

--------------------------------------------------------------------------------------------------------
-- USER CHO VIỆC AUDIT CÂU 2 LÀ NV004 - NV TCHC

CREATE ROLE ROLE_NVPKT;

-- QUYỀN CHO NV_PKT
GRANT ROLE_NVCB TO ROLE_NVPKT;
GRANT CONNECT, CREATE SESSION TO ROLE_NVPKT;
GRANT SELECT, UPDATE(DIEMQT, DIEMTH, DIEMTK, DIEMCK) ON DANGKY TO ROLE_NVPKT;

-- Tạo user USER_PKT
CREATE USER NV009 IDENTIFIED BY 9;

-- Cấp quyền cho user
GRANT ROLE_NVPKT TO NV009;
GRANT EXECUTE ON ATBMCQ_ADMIN.IS_ADMIN_USER TO NV009;