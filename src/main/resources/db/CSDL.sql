...
--ALTER PLUGGABLE DATABASE ATBMCQ_16_CSDL CLOSE IMMEDIATE
--DROP PLUGGABLE DATABASE ATBMCQ_16_CSDL INCLUDING DATAFILES;
...
GRANT EXECUTE ON DBMS_SESSION TO ATBMCQ_ADMIN;
